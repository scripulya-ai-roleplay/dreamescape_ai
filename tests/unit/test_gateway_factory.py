...
class TestGatewayFactory:
    ...
    def gateway_registry(self, mock_google_gateway, mock_mock_gateway):
        ...
        return {
            "google": mock_google_gateway,
            "mock": mock_mock_gateway
        }
    ...
    def test_factory_registry_immutability(self, gateway_factory):
        """Test that modifying registry after creation doesn't affect factory"""
        # Arrange
        original_gateways = gateway_factory._gateways.copy()
