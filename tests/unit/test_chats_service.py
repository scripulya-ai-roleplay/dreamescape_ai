...
class TestChatsService:
    ...
    @pytest.mark.asyncio
    async def test_send_message_success_gemini(self, chats_service, mock_gateway_factory, mock_gateway, sample_user_message_dto):
    ...
    @pytest.mark.asyncio
    async def test_send_message_success_mock_model(self, chats_service, mock_gateway_factory, mock_gateway, sample_mock_message_dto):
    ...
    @pytest.mark.asyncio
    async def test_send_message_gateway_response_error(self, chats_service, mock_gateway_factory, mock_gateway, sample_user_message_dto):
    ...
    @pytest.mark.asyncio
    async def test_send_message_different_response_format(self, chats_service, mock_gateway_factory, mock_gateway, sample_user_message_dto):
